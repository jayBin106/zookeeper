...
public class DistributedQueueDemo {
    ...
    public void test() throws Exception {
        ...
        CuratorFramework clientA = CuratorFrameworkFactory.newClient(zookeeperAddress, 5000, 3000, retry);
        clientA.start();
        CuratorFramework clientB = CuratorFrameworkFactory.newClient(zookeeperAddress, 5000, 3000, retry);
        clientB.start();
